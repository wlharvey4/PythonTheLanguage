...
* Why Python? --- Which Python?
:PROPERTIES:
:appendix: t
:END:

#+attr_texinfo: :author https://www.reddit.com/r/perl/comments/d2yix0/how_did_perl_lose_ground_to_bash/
#+begin_quote
I know a comp sci professor.  I asked why he thought Python was so popular.

"Every teacher I know has students using it.  We do it because it's an easy
language, there's only one way to do it, and with whitespace as syntax it's
easy to grade.  We don't teach it because it is some powerful or exceptional
language."
